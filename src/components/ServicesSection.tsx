...
export default function ServicesSection() {
    ...
    return (
        <section className="w-full px-3 mb-15 md:px-0 h-fit pb-20 flex flex-col" id='servicios'>
            ...
            <article className="w-full md:w-3/4 mt-20 shadow-custom m-auto md:h-96 flex flex-col md:flex-row gap-5 bg-white rounded-2xl shadow-custom">
                <div className="h-44 md:h-96 w-full md:w-2/6 flex items-center  justify-center rounded-2xl bg-white">
                    <img src={selectedService.display}  className="object-contain" alt="" />
                </div>
                <div className="w-full max-h-full md:w-4/6 md:my-10 py-10 flex flex-col justify-between md:py-0 px-5 md:pr-5">
                    <div>
