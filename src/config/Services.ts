import type { selectedService } from "./definitions"

const services: selectedService[] = [
    {
        "title": "VR - 360",
        "img": "/assets/icons/vr.svg",
        desc:[
            "Permite trasladar al usuario a un entorno digital inmersivo.",
    ...
    },
    {
        ...
        desc:[
            "Permiten al usuario explorar contenidos a su ritmo, con una experiencia visual",
    ...
    {
        "title": "Holograma",
        "img": "/assets/icons/hologram.svg",
        desc:[
            "La holografía genera un efecto visual único, ideal para captar la atención de audiencias exigentes.",
    ...
    },
    {
        ...
        "img": "/assets/icons/aumentada.svg",
        desc:[
